...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Moviethete/ALCameraViewController.framework"
  ...
  install_framework "Pods-Moviethete/SwiftLocation.framework"
  install_framework "Pods-Moviethete/SwiftValidator.framework"
  install_framework "Pods-Moviethete/SwiftyJSON.framework"
  install_framework "Pods-Moviethete/SwiftyTimer.framework"
